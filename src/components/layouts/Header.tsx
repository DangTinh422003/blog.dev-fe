...
import { type RootState, useAppDispatch } from '@/stores/store';
...
const Header = () => {
  const userLogined = useSelector((e: RootState) => e.auth.user);
  ...
  return (
    <div className="sticky left-0 top-0 z-30">
      <div
        className={`
          flex h-16 w-full items-center justify-between border-b bg-background
          px-4
        `}
      >
        ...
        <div
          className={`
            hidden w-96 flex-1 items-center gap-2 rounded-lg px-2
              ...
              <DropdownMenuTrigger asChild>
                ...
                >
                  <Avatar className="size-6 rounded-lg">
                    <AvatarImage
                      src={
                        userLogined.avatar || 'https://github.com/shadcn.png'
                      }
                    />
